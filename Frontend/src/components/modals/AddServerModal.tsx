        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="bg-white dark:bg-black text-black dark:text-white p-0 overflow-hidden">
                ...
                <DialogFooter className="bg-gray-100 dark:bg-black px-6 py-4 grid grid-cols-2">
                    <div
                        className={`cursor-pointer justify-center items-center rounded-lg flex px-4 py-2 ${activeForm === 'create' ? 'bg-blue-600 text-white' : 'bg-blue-600 text-white'}`}
                        onClick={() => setActiveForm('create')}
                    >
                        Create Server
                    </div>
                    <div
                        className={`cursor-pointer justify-center items-center rounded-lg flex px-4 py-2 ${activeForm === 'join' ? 'bg-blue-600 text-white' : 'bg-blue-600 text-white'}`}
